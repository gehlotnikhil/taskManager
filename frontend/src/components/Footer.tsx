...
<footer className="bg-neutral-primary-soft bg-black">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link to="https://flowbite.com/" className="flex items-center">
                  <img src="https://flowbite.com/docs/images/logo.svg" className="h-7 me-3" alt="FlowBite Logo" />
                  <span className="text-white text-heading self-center text-2xl font-semibold whitespace-nowrap">Flowbite</span>
              </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-heading uppercase text-white">Resources</h2>
                  <ul className="text-body font-medium">
                      <li className="mb-4">
                          <Link to="https://flowbite.com/" className="text-white hover:underline">Flowbite</Link>
                      </li>
                      <li>
                          <Link to="https://tailwindcss.com/" className="text-white hover:underline">Tailwind CSS</Link>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-heading uppercase text-white">Follow us</h2>
                  <ul className="text-body font-medium">
                      <li className="mb-4">
                          <Link to="https://github.com/themesberg/flowbite" className="hover:underline text-white">Github</Link>
                      </li>
                      <li>
                          <Link to="https://discord.gg/4eeurUVvTy" className="hover:underline text-white">Discord</Link>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-heading uppercase text-white">Legal</h2>
                  <ul className="text-body font-medium">
                      <li className="mb-4">
                          <Link to="/" className="hover:underline text-white">Privacy Policy</Link>
                      </li>
                      <li>
                          <Link to="/" className="hover:underline text-white">Terms &amp; Conditions</Link>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-body sm:text-center text-white">© 2023 <Link to="https://flowbite.com/" className="hover:underline ">Flowbite™</Link>. All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <Link to="/" className="text-body hover:text-heading ms-5">
                ...
                <span className="sr-only text-white">Dribbble account</span>
            </Link>
          </div>
      </div>
    </div>
